...
namespace Device.Model
{
    ...
    public enum EnumHardwareStatus
    {
        ...
        /// 需要重启软件（在线分析软件）
        /// </summary>
        [Description("需要重启软件,Restart Software")]
        RestartSoftware = 7,
        /// <summary>
        /// 需要重启系统（在线分析软件）
        /// </summary>
        [Description("需要重启系统,Restart System")]
        RestartSystem = 8,
    }

    /// <summary>
    /// 设备类型，FTNIR，FTIR，GratingNIR，MemsNIR,RAMAN
    /// </summary>
    public enum EnumDeviceCategory
    {
        ...
        /// FTNIR
        /// </summary>
        [Description("傅里叶近红外,FTNIR")]
        FTNIR = 1,
        /// <summary>
        /// FTIR
        /// </summary>
        [Description("傅里叶中红外,FTIR")]
        FTIR = 2,
        /// <summary>
        /// Grating NIR
        /// </summary>
        [Description("光栅近红外,Grating NIR")]
        GratingNIR = 3,
        /// <summary>
        /// Filter NIR
        /// </summary>
        [Description("滤光片近红外,Filter NIR")]
        FilterNIR = 4,
        /// <summary>
        /// Mems NIR
        /// </summary>
        [Description("芯片近红外,MEMS NIR")]
        MemsNIR = 5,
        /// <summary>
        /// RAMAN
        /// </summary>
        [Description("拉曼,RAMAN")]
        RAMAN = 6,
    }
    ...
    public enum EnumDeviceModel
    {
        ...
        /// Solid Handset
        /// </summary>
        [Description("固体手持式,SolidHandset")]
        SolidHandset = 32,
        /// <summary>
        /// Liquid Handset
        /// </summary>
        [Description("液体手持式,LiquidHandset")]
        LiquidHandset = 64,
    }
    ...
    public enum EnumDeviceDetector
    {
        ...
        /// CCD
        /// </summary>
        [Description("铟镓砷二极管检测器,InGaAs Diode")]
        InGaAsDiode = 32,
    }
    ...
    public enum EnumDeviceScanMode
    {
        ...
        /// Double Sampling
        /// </summary>
        [Description("A峰采样,A Sampling")]
        APeak = 1,
        /// <summary>
        /// Average Sampling
        /// </summary>
        [Description("B峰采样,B Sampling")]
        BPeak = 2,
        /// <summary>
        /// Double Average Sampling
        /// </summary>
        [Description("双峰采样,Couple Sampling")]
        ABPeak = 3,
        /// <summary>
        /// Double Side
        /// </summary>
        [Description("双边采样,Double Side")]
        DoubleSide = 4,
        /// <summary>
        /// Single Side
        /// </summary>
        [Description("单边采样,Single Side")]
        SingleSide = 5,
    }
    ...
    /// </summary>
    public enum EnumDeviceSwitcheraaa
    {
        /// <summary>
        /// Off
        /// </summary>
    ...
    /// 分辨率列表
    /// </summary>
    public enum EnumDeviceResolutionsaaaa
    {
        /// <summary>
        /// 1 cm-1
        /// </summary>
    ...
    /// Instrument model
    /// </summary>
    public enum EnumDeviceBrandaaa
    {
        /// <summary>
        /// Unknown
        /// </summary>
        [Description("为准,Unknown")]
        Unknown,
        /// <summary>
        /// Default
        /// </summary>
        ...
        /// Bruer MPA
        /// </summary>
        [Description("布鲁克MPA,Bruker MPA")]
        Bruer_MPA,
        /// <summary>
        /// Bruer Tango
        /// </summary>
        [Description("布鲁克Tango,Bruker Tango")]
        Bruer_Tango,
        /// <summary>
        /// Bruer Matrix_E
        /// </summary>
        [Description("布鲁克Matrix-E,Bruker Matrix-E")]
        Bruer_Matrix_E,
        /// <summary>
        /// Bruer Matrix_F
        /// </summary>
        [Description("布鲁克Matrix-F,Bruker Matrix-F")]
        Bruer_Matrix_F,
        /// <summary>
        /// Bruer Matrix_I
        /// </summary>
        [Description("布鲁克Matrix-I,Bruker Matrix-I")]
        Bruer_Matrix_I,
        /// <summary>
        /// Bruer Tensor
        /// </summary>
        [Description("布鲁克Tensor,Bruker Tensor")]
        Bruer_Tensor,
        /// <summary>
        /// Catron IIS100
        /// </summary>
        ...
        /// ChemChina ViewDeep
        /// </summary>
        [Description("中国化工 无敌谱,ChemChina ViewDeep")]
        ChemChina_ViewDeep,
        /// <summary>
        /// ChemChina Solid OnePoint
        /// </summary>
        [Description("中国化工 固体一点通,ChemChina Solid OnePoint")]
        ChemChina_SolidOnePoint,
        /// <summary>
        /// ChemChina Liquid OnePoint
        /// </summary>
        [Description("中国化工 液体一点通,ChemChina Liquid OnePoint")]
        ChemChina_LiquidOnePoint,
    }

    /// <summary>
    /// Instrument factor
    /// </summary>
    public enum EnumDeviceFactoraaa
    {
        /// <summary>
        /// Unknown
        /// </summary>
    ...
    public enum EnumAcquireCommand
    {
        ...
        /// Start live acquire
        /// </summary>
        [Description("实时监测开始,Live Start")]
        LiveStart = 0,
        /// <summary>
        /// Start background
        /// </summary>
        [Description("扫描开始,Spectrum Acquire Start")]
        ScanStart = 1,
        /// <summary>
        ...
        /// Start background
        /// </summary>
        [Description("扫描背景光谱开始,Reference Acquire Start")]
        ReferenceStart = 3,
    }
    ...
    /// 设备采集的数据格式
    /// </summary>
    public enum EnumAcquireDataTypeaaa
    {
        /// <summary>
        /// 原始数据
        /// </summary>
    ...
    /// 结果谱图类型
    /// </summary>
    public enum EnumResultSpectrumaaa
    {
        /// <summary>
        /// Background Interfergoram
        /// </summary>
        [Description("背景干涉谱,Background Interfergoram")]
        BackInterfer = 0,
        /// <summary>
        ...
        Raw = 10,
        /// <summary>
        ///Reference raw  data(YINTENS)
        /// </summary>
        [Description("参考原始谱,Reference raw data")]
        ReferenceRawData = 11,
        /// <summary>
        /// Sample raw data(YRELINT)
        /// </summary>
        [Description("样品原始谱,Sample raw data")]
        SampleRawData = 12,
        /// <summary>
        /// Dark Raw data(YENERGY)
        /// </summary>
        [Description("暗电流,Dark data")]
        DarkRawData = 13,
    }
    ...
    /// 保存的光谱文件格式
    /// </summary>
    public enum EnumSaveFileTypetemp
    {
        /// <summary>
        /// SPC
        /// </summary>
    ...
    /// FT填零
    /// </summary>
    public enum EnumFTZeroFillingaaaa
    {
        ///// <summary>
        ///// Filling 0
        ///// </summary>
    ...
    /// 重复扫描次数
    /// </summary>
    public enum EnumRepeatCountaaaa
    {
        /// <summary>
        /// Repeat 0
        /// </summary>
    ...
    /// 背景光谱的有效期
    /// </summary>
    public enum EnumBackgroundDurationaaaaaa
    {
        /// <summary>
        /// 15 minutes
        /// </summary>
