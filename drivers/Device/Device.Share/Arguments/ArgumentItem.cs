...
namespace AH.DeviceDriver.Share.Argument
{
    ...
    public class ArgumentItem:ArgumentBase
    {
        ...
        public ArgumentItem(string innerName, string valueType, string? value = null, EnumArgumentScope scope = EnumArgumentScope.EachTime, EnumArgumentAuthor author = EnumArgumentAuthor.System)
