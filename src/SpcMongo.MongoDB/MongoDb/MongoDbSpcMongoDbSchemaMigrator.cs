...
public class MongoDbSpcMongoDbSchemaMigrator : ISpcMongoDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSpcMongoDbSchemaMigrator(IServiceProvider serviceProvider)
    {
